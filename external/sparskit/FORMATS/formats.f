...
c----------------------------------------------------------------------- 
      subroutine csrsss (nrow,a,ja,ia,sorted,diag,al,jal,ial,au,iwork)
      real*8 a(*),al(*),diag(*),au(*) 
...
c iwork = working array of the size of nnz of a
c----------------------------------------------------------------------- 
c 
...
c 
      if (.not. sorted) then
         call csort (nrow, al, jal, ial, iwork, .true.) 
      endif
c
c copy u
c 
...
c     Work space:
c----------------
c     iwk(1:2*nnz) = working array for csort
