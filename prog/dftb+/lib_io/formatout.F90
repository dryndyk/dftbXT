...
204 format(A5,7F16.8)
  ...
  subroutine printDFTBHeader(release, year, outunit)
    ...
    write(outunit, '(A)') repeat(hBar, headerWidth)
    write(outunit, '(5A)') hBar,hBar, repeat(' ', headerWidth - 4),hBar,hBar
    write(outunit, '(5A)') hBar,hBar,'                               DFTB+XT 1.04.**                              ',hBar,hBar 
    write(outunit, '(5A)') hBar,hBar, repeat(' ', headerWidth - 4),hBar,hBar
    ...
    write(outunit, '(A)') repeat(hBar, headerWidth)
    write(outunit, '(5A)') hBar,hBar, repeat(' ', headerWidth - 4),hBar,hBar
    write(outunit, '(5A)') hBar,hBar,' Please cite as: DFTB+XT software package from TraNaS OpenSuite [1],        ',hBar,hBar
    write(outunit, '(5A)') hBar,hBar,' partially based on the DFTB+ software package [2,3].                       ',hBar,hBar
    write(outunit, '(5A)') hBar,hBar, repeat(' ', headerWidth - 4),hBar,hBar
